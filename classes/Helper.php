...
class Helper{
    ...
    public function subscriber_unique_token(){
        ...
        do{
            ...
            $is_duplicate = (int) $wpdb->get_var("select count(id) from {$wpdb->prefix}lp_subscribers WHERE token = '{$rand_string}' ");
        } while ($is_duplicate);
    ...
    public function campaign_unique_slug(){
        ...
        do{
            $rand_string = $this->random_str();
            $is_duplicate = (int) $wpdb->get_var("select count(id) from {$wpdb->prefix}lp_campaigns WHERE slug = '{$rand_string}' ");
        } while ($is_duplicate);
