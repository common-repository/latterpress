<div class="wrap">
    ...
    <form method="post" action="options.php">
        ...
        <div class="lp-settings-row">
            ...
            <div class="lp-settings-field">
                <input name="lp_option[from_email]" type="email" value="<?php echo LPRESS()->h->from_email(); ?>" spellcheck="false" placeholder="<?php echo $admin_email; ?>">
        ...
        <div class="lp-settings-row">
            ...
            <div class="lp-settings-field">
                ...
                <input name="lp_option[from_name]" type="text" value="<?php echo LPRESS()->h->from_name(); ?>" spellcheck="false" placeholder="<?php echo $admin_email; ?>">
